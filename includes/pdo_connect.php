...
try{
  ...
  $sDatabasePassword = '';
  $databaseSourceName= "mysql:host=localhost; dbname=mandatory_one; charset=utf8mb4";
  ...
  $db = new PDO( $databaseSourceName, $sDatabaseUserName, $sDatabasePassword, $aDatabaseOptions );
